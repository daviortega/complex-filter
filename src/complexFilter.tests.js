...
describe('complexFilter', function() {
	describe('simple queries and different searchTypes', function() {
		...
		it.skip('should match exact with "exact"', function() {
			const expected = [
				{
					"date": 1237939200,
					"NBCItaxID": 80880,
		...
		it.skip('should match at the beginning with "startsWith"', function() {
			const expected = [
				{
					"date": 1237939200,
					"NBCItaxID": 80880,
		...
		it.skip('should match at the end with "endsWith"', function() {
			const expected = [
				{
					"date": 1237939200,
					"NBCItaxID": 80880,
		...
		it.skip('should match regex with "regex"', function() {
			const expected = [
				{
					"date": 1237939200,
					"NBCItaxID": 80880,
		...
		it.skip('should not match any using special regex characters in "contains"', function() {
			const expected = []
			const objectStream = Readable({objectMode: true})
			const objects = require(objectsFilename)
			objects.map((object) => {
		...
		it.skip('should match exact with "exactValue" with numbers', function() {
			const expected = [
				{
					"date": 1180569600,
					"NBCItaxID": 1076,
		...
		it.skip('should match smaller values with "lessThan"', function() {
			const expected = [
				{
					"date": 1180569600,
					"NBCItaxID": 1076,
		...
		it.skip('should match larger values with "greaterThan"', function() {
			const expected = [
				{
					"date": 1132617600,
					"NBCItaxID": 90880,
		...
		it.skip('should match values between two values passed as "between"', function() {
			const expected = [
				{
					"date": 1132617600,
					"NBCItaxID": 8080,
